  ...
  const SaveAllAndPublish = async () => {
    ...
    try {
      ...
      const obj = {
        ...
        title: title ? title : 'Getting started with gassless transactions',
        description: description
          ? description
          : 'Getting started with gassless transactions and basics concepts to get started in your journey.',
              ...
              <Flex>
                <Center>
                  <p className={styles.profileParaghap}>
                    Publish for free using the Gasless Wallet SDK sponsored by
                  </p>
                  <Image
                    alt="badge"
                    src="/gelato.png"
